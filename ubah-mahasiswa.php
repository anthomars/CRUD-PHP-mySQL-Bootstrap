<?php
    ...
    //ambil is mahasiswa dr url
    $id_mahasiswa = (int)$_GET['id_mahasiswa'];

    //query ambil data mhs
    $mahasiswa = select("SELECT * FROM mahasiswa WHERE id_mahasiswa = $id_mahasiswa")[0];
?>
    <div class="container mt-5">
        <h1><i class="fas fa-user"></i> Edit Data Mahasiswa</h1>
        <hr>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img src="assets/img/<?= $mahasiswa['foto']; ?>" class="img-thumbnail img-preview mt-2" alt="foto" width="100px">
            </div>
