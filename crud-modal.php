<?php
    ...
    //tampil berdasarka user login
    $id_akun = $_SESSION['id_akun'];
    $data_bylogin = select("SELECT * FROM akun WHERE id_akun = $id_akun");

    //aksi tombol tambah modal
...
<div class="container mt-5">
    ...
    <button href="" class="btn btn-primary mb-1" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class="fas fa-plus-circle"></i> Tambah</button>
    <?php endif; ?>
    ...
    <table class="table table-striped table-bordered mt-3" id="table">
        ...
        <tbody>
            ...
            <?php if($_SESSION['level'] == 1) : ?>
              ...
              <?php endforeach; ?>
            <?php else: ?>
              <!-- tampil data berdasarkan data login -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-success text-white">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-user"></i> Ubah Akun</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="" method="post">
            ...
            <?php if($_SESSION['level'] == 1) : ?>
                <div class="mb-3">
                  ...
                  <select name="level" id="level" class="form-control" required>
                      ...
                      <option value="3"<?= $level == '3' ? 'selected' : null?>>0perator Mahasiswa</option>
                  </select>
                </div>
                <?php else: ?>
